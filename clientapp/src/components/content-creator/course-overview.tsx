            ...
            >
                <Table stickyHeader size="small" sx={{
                    ...
                    <TableHead>
                        <TableRow>
                            {[
                                { id: 'id' as SortableColumn, label: 'Id', width: '5%' },
                                ...
                                { id: 'typicalLearningTime' as SortableColumn, label: 'Typical Learning Time', width: '10%' },
                                { id: 'averageLearningTime' as SortableColumn, label: 'Average Learning Time', width: '10%' },
                                { id: 'averageGrade' as SortableColumn, label: 'Average Grade', width: '10%' },
                                { id: 'averageAttemptsToPass' as SortableColumn, label: 'Average Attempts', width: '10%' },
                                { id: 'averageRating' as SortableColumn, label: 'Average Rating', width: '10%' }
                            ].map((column) => (
                                <TableCell
                                    key={column.id}
                    ...
                    <TableBody>
                        {sortRows(rows).map((row, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell sx={{ width: '10%' }} align="left">{row.averageLearningTime}</TableCell>
                                <TableCell sx={{ width: '10%' }} align="left">{row.averageGrade} points</TableCell>
